...
| ADR-0046 | Significant Data Fiduciary foundation — sdf_status on organisations + DPIA records + auditor engagements | Proposed | 2026-04-18 | 4 | 5 |
| ADR-0047 | Customer membership lifecycle (role change + remove) + membership_audit_log + single-account-per-identity invariant | In Progress | 2026-04-18 | 1 | 2 |
