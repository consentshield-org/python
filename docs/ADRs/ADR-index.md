...
| ADR-1004 | v2 Whitepaper Phase 4 — Statutory retention (Regulatory Exemption Engine) + material-change re-consent + silent-failure detection; Phase 1 Sprints 1.1-1.5 shipped 2026-04-22 (schema + BFSI/Healthcare seeds + deletion orchestrator integration + `/dashboard/compliance/retention` customer page + `GET/POST /api/orgs/[orgId]/regulatory-exemptions`); Phase 2 Sprint 2.1 shipped 2026-04-22 (notices schema + append-only invariant + publish_notice auto-versioning RPC + consent_events.notice_version FK; 9/9 tests PASS); Phase 3 Sprints 3.1 + 3.2 shipped 2026-04-22 (orphan consent-events metric + pg_cron monitor + Compliance Health dashboard widget); Sprint 1.6 legal review + Phase 2 Sprints 2.2 + 2.3 UI blocked on wireframes | In Progress | 2026-04-19 | 3 | 9 |
